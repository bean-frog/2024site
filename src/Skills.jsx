...
function Skills() {
     return (
        <div className="border-2 border-full border-glass-border bg-gradient-to-tr from-glass-dark/40 via-glass-reflective/50 to-glass-dark/40 rounded-md p-6 flex flex-col items-center justify-center backdrop-blur-sm">
